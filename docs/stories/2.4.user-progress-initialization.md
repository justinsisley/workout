...
### File List
- **Modified**: `src/actions/programs.ts` - Enhanced assignProgramToUser with structure validation, added advanceToNextDay and advanceToNextMilestone functions
- **Modified**: `src/types/program.ts` - Updated UpdateProgressResult type to include 'not_found' error type
