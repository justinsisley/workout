...
- `tests/payload/collections.test.ts` - Comprehensive unit tests for collections (34 test cases)

**Modified Files:**

- `src/payload/payload.config.ts` - Added Exercises, Sessions, and Milestones collection imports and registration
