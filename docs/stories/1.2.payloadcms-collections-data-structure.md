...
- `tests/payload/collections.test.ts` - Comprehensive unit tests for collections (58 test cases)

**Modified Files:**

- `src/payload/payload.config.ts` - Added Exercises, Sessions, Milestones, Programs, and ProductUsers collection imports and registration
