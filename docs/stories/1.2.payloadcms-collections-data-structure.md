...
- `tests/payload/collections.test.ts` - Comprehensive unit tests for collections (46 test cases)

**Modified Files:**

- `src/payload/payload.config.ts` - Added Exercises, Sessions, Milestones, and Programs collection imports and registration
