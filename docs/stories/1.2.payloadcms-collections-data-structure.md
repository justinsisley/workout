...
- `tests/payload/collections.test.ts` - Comprehensive unit tests for collections (18 test cases)

**Modified Files:**

- `src/payload/payload.config.ts` - Added Exercises and Sessions collection imports and registration
