...
- [x] **Time duration input field** (AC: 6)
  ...
  - [Source: course-corrections/time-based-exercise-support.md]
...
- **Time duration input field** - Successfully implemented duration field in exercise configuration within embedded days array in `src/payload/collections/programs.ts`. Field accepts seconds (0-3600 max), positioned alongside existing exercise fields (sets, reps, weight), with clear description for time-based exercises. TypeScript compilation verified successful.
