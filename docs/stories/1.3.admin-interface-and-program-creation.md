...
- [ ] **Distance input with unit selector** (AC: 6) [ENHANCEMENT - Course Correction Required]
  ...
  - [ ] Update field layout to accommodate dual fields in exercise row with visual grouping
