...
- [ ] Create workout dashboard page component (AC: 1, 7, 11)
  - [ ] Implement `src/app/(frontend)/workout/dashboard/page.tsx` as server component
  - [ ] Add protected route authentication using auth middleware
  - [ ] Implement error boundaries for dashboard-level error handling
